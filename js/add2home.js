...
var nav = navigator,
	...
	options = {
		...
		message: 'Add <strong>SimpleGo</strong> to your <strong>%device</strong>: tap %icon and then <strong>Add to Home Screen.',				// Customize your message or force a language ('' = automatic)
